...
import { DevelopmentEnvironmentInstructions } from '~/scenes/get-stahttps://play.google.com/store/apps/details?id=com.twgbd.dimsrted/set-up-your-environment/DevelopmentEnvironmentInstructions';
